          ...
          <div class="card-body p-4 d-flex flex-column justify-content-between">
            <div>
              <p class="text-muted small mb-3">
                Siga estos pasos para preparar el archivo con los NIT de las sociedades a emitir:
              </p>
              ...
              <div class="d-flex flex-column gap-3 mb-4">
                ...
                <div class="d-flex align-items-start gap-3">
                  ...
                  <div class="small text-secondary">
                    Abra el archivo y complete la columna <strong class="text-dark">nit_sociedad</strong> agregando el NIT por fila sin guion ni dígito de verificación (ej. <code>900123456</code>).
                  </div>
                </div>
                <div class="d-flex align-items-start gap-3">
              ...
              <div class="info-block-box mb-4">
                ...
                <ul class="text-muted small mb-0 ps-3">
                  <li>Encabezado obligatorio: <code>nit_sociedad</code></li>
                  <li>Formato del NIT: Solo números sin guion ni dígito de verificación</li>
      ...
      <div class="col-lg-7 col-xl-7">
        <section class="card shadow-sm border-0 h-100">
          ...
          <div class="card-body p-4 d-flex flex-column justify-content-between">
            <div>
              <p class="text-muted small mb-3">
                Seleccione el archivo preparado para validar los registros societarios y emitir automáticamente las credenciales digitales.
              </p>

              <div class="mb-3">
                <label for="bulkSocietyTramite" class="form-label fw-semibold text-secondary small mb-1">
                  Tipo de trámite del lote
                </label>
                <select
                  id="bulkSocietyTramite"
                  class="form-select"
                  [ngModel]="tipoTramite"
                ...
                <small class="text-muted" style="font-size: 11px;">
                  Define el trámite con el que se consultará cada NIT en los servicios de la JCC.
                </small>
              </div>

              <div class="mb-3">
                <label for="bulkSocietyFile" class="form-label fw-semibold text-secondary small mb-1">
