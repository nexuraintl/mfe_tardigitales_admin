    ...
    <div class="card shadow-sm border-0 mb-4 col-lg-8 mx-auto">
      ...
      <div class="card-body p-4">
        <ol class="text-muted small mb-4">
          <li class="mb-2">Descargue la plantilla y complete la columna <code>numero_identificacion</code> por fila.</li>
          <li>Suba el archivo: el sistema consultará las matrículas y emitirá las credenciales automáticamente.</li>
        </ol>
        ...
        <div class="mb-3">
          <label for="bulkIssueFile" class="form-label fw-semibold">Seleccionar archivo CSV</label>
          <div class="input-group">
            <input type="file" id="bulkIssueFile" accept=".csv,.txt,text/csv,text/plain" class="form-control" (change)="seleccionarArchivo.emit($event)">
